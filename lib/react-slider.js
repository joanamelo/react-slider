...
/***/ function(module, exports, __webpack_require__) {
	...
	var _scrollTo = __webpack_require__(33);
	...
	var Slider = function (_PureComponent) {
	    ...
	    function Slider(props) {
	        ...
	        var _this$props = _this.props,
	            touchSensitivity = _this$props.touchSensitivity,
	            scrollingSpeed = _this$props.scrollingSpeed,
	            className = _this$props.className,
	            scrollPendingThreshold = _this$props.scrollPendingThreshold;
	        ...
	        _this.preventBouncing = _this.preventBouncing.bind(_this);
	    ...
	    _createClass(Slider, [{
	        ...
	        key: 'setSlidesElem',
	        value: function setSlidesElem(elem) {
	            ...
	            return _react2.default.createElement(
	                'div',
	                {
	                    ref: function ref(elem) {
	                        return _this2.setSlidesElem(elem);
	                    },
	                    style: style,
	                    className: className },
	                this.props.children
	        ...
	        key: 'moveToSlideInViewPort',
	        value: function moveToSlideInViewPort() {
	            if (!this.slidesElem) {
	                return;
	            }
	            ...
	            var offset = this.slides[0] - this.slidesElem.getBoundingClientRect().top;
	        ...
	        key: 'moveToSlide',
	        value: function moveToSlide(idx) {
	            var _this3 = this;

	            var _state = this.state,
	                scrollingSpeed = _state.scrollingSpeed,
	                scrollPendingThreshold = _state.scrollPendingThreshold;


	            this.currentSlide = idx;

	            (0, _scrollTo2.default)(this.slides[idx], scrollingSpeed, 'easeOutSine', function () {
	                setTimeout(function () {
	        ...
	        key: 'updateSlidesOffsets',
	        value: function updateSlidesOffsets() {
	            var slides = [];

	            for (var i = 0; i < this.props.total; i += 1) {
	        ...
	        value: function isInViewPort() {
	            ...
	            return slidesPosition.start <= 0 && slidesPosition.end > window.innerHeight || slidesPosition.start < 0 && slidesPosition.end >= window.innerHeight;
	        }
	        ...
	        key: 'onInitialScroll',
	        value: function onInitialScroll() {
	            this.updateSlidesOffsets();
	        ...
	        key: 'preventBouncing',
	        value: function preventBouncing(e) {
	            if (this.isBlocked) {
	        ...
	        key: 'touchEventPosition',
	        value: function touchEventPosition(e) {
	            return {
	        ...
	        set: function set(idx) {
	            var _props$notifyCurrent = this.props.notifyCurrent,
	                notifyCurrent = _props$notifyCurrent === undefined ? function () {} : _props$notifyCurrent;
	...
	Slider.propTypes = {
	    ...
	    scrollPendingThreshold: _react2.default.PropTypes.number,
	    scrollingSpeed: _react2.default.PropTypes.number,
	    total: _react2.default.PropTypes.number.isRequired,
	    touchSensitivity: _react2.default.PropTypes.number,
	    className: _react2.default.PropTypes.string,
	    notifyCurrent: _react2.default.PropTypes.func,
...
/***/ function(module, exports) {
	...
	exports.default = function () {
	    ...
	    var scrollY = scrollY || (window.pageYOffset || doc.scrollTop) - (doc.clientTop || 0);
